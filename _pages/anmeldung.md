...
<select id="kurs" name="Kurs" required>
  <option value="RE@AGILE 17.-19. Juni 2026, online">RE@AGILE,  17.-19. Juni 2026, online</option>
  <option value="RE@AGILE 24.-26. November 2026, Wien">RE@AGILE,  4.-26. November 2026, Wien</option>
...
<hr style="height:2px; width:100%; border-width:0; color:CadetBlue; background-color:CadetBlue">
  ...
  <button type="submit" id="submit" class="btn btn-custom-red" >Anmeldung absenden</button>
  <input type="button" value="Zurück" class="btn btn--primary" onclick="history.back()" style="float: right;">
...
-->
<input type="hidden" name="_email.subject" value="[req42.de] ANMELDUNG" />
<input type="hidden" name="_email.from" value="req42.de Website (via formspark.io)" />
<input type="hidden" name="_email.template.title" value="Anmeldung (via req42.de)" />
